...
# pdf(file.path(out_dir, "DeKegel_top5_combined_cn_vs_drug_sens_WRST_pval_signif_plus_cn_update3_noFinan.pdf"),
#     width = 4, height = 2.5)
# for(i in 1:n_pages){
#   p <-  ggplot(d.DeKegel_top5_combined_cn_drug_pair_pval_signif,
#                aes(x = combined_cn_bin, y = dependency, fill = combined_cn_bin)) +
...
#               map_signif_level = FALSE,
#               test = "wilcox.test",
#               test.args = list(alternative = "greater", p.adjust.method = "BH"),
