...
# make_lm_plot(d.drug_sens_all_genes_expr_lm_pos_slope, fdr, 0.1, 50)
# 
# make_lm_plot(d.drug_sens_all_genes_expr_lm_neg_slope, fdr, 0.1, 50)
...
make_lm_lineage_plot <- function(df, col_name, stat_cutoff, plot_n){
  ...
  for(i in 1:n_pages){
    ...
    q <- ggplot(d.plot, aes(x = lineage, y = log_tpm)) +
      geom_jitter(width = 0.3, size = 1) +
      geom_boxplot(alpha = 0, color = "gray60") +
...
# make_lm_lineage_plot(d.drug_sens_all_genes_expr_lm_pos_slope, fdr, 0.1, 50)
# 
# make_lm_lineage_plot(d.drug_sens_all_genes_expr_lm_neg_slope, fdr, 0.1, 50)
